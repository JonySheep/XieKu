...
Page({
  ...
  {
      wx.request({
          url   : 'https://www.swahouse.com/api/Activity/addActivityNumnber',
          data  : {
              id : activityId
          },
  ...
  {   
      ...
      console.log(usersId)
      wx.request({
          url  : 'https://www.swahouse.com/api/Activity/getActivityFind',
          data : {
              id        : activityId,
              users_id  : usersId
          },
  ...
  { 
      wx.request({
          url  : 'https://www.swahouse.com/api/Activity/getActivityBanner',
          success : function(rsf)
          {
              console.log(rsf)
          }
  ...
  {   
      ...
      if( ! openId )
      {
          ...
          wx.request({
              url   : 'https://www.swahouse.com/api/Activity/activityCollect',
              data  : {
  ...
  {   
      ...
      if( !openId )
      {
         wx.switchTab({
          ...
          wx.request({
              url  : 'https://www.swahouse.com/api/Activity/activityConversion',
              data : {
                  activity_id   : activityId,
                  users_id      : usersId
              },
